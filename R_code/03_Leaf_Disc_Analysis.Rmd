...
|  |  |  |
|-------------------|------------------|-----------------------------------|
| Likelihood ratio w/ batch | 46.44 | the model with batch explains more structure in the data than the model without |
| P value m1 w/ batch | \< 0.0001 | batch contributes significant variance to disease severity |
| Delta AIC | 45 | very strong support (AIC \> 10 = strong support) |
...
```
Residual variance increases with disease severity. This increase happens in bin 2 (low-moderate severity) and bin 3 (moderate-high severity), followed by a bit of a taper in bin 3 (high severity).
